...
|   |   database_setup.py               # Database engine and session setup
|   |   models.py                       # ORM table classes (User, HealthReading)
|   |   schemas.py                      # Pydantic schemas for data validation
|   |             
+---models
|   +---female_model/                           # Female prediction model artifacts
|   |       female_diabetes_model_info.json
|   |       female_feature_scaler.pkl
|   |       female_final_ensemble_model.pkl
|   |       
|   \---male_model/                             # Male prediction model artifacts
...
1. **Clone the repository:**
   ```
   git clone https://github.com/insanjay/diabetes_prediction.git
   cd DiabetaPredict
   ```
...
**Your Name**
- GitHub: [@yourusername](https://github.com/insanjay)
- LinkedIn: [Your LinkedIn](https://linkedin.com/in/insanjay)
